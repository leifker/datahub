...
public class ProtobufExtensionFieldVisitorTest {
    ...
    public void extendedMessageTest() throws IOException {
        ...
        List<SchemaField> expected = Stream.of(
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=string].name")
                                .setNullable(true)
                ...
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=string].email")
                                .setNullable(true)
                                .setIsPartOfKey(false)
                                .setDescription("")
                                .setNativeDataType("string")
                ...
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=extended_protobuf_Department].dept")
                                .setNullable(true)
                                .setIsPartOfKey(false)
                                .setDescription("")
                ...
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=extended_protobuf_Department].dept.[type=int].id")
                                .setNullable(true)
                                .setIsPartOfKey(false)
                                .setDescription("")
                                .setNativeDataType("int32")
                ...
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=extended_protobuf_Department].dept.[type=string].name")
                                .setNullable(true)
                                .setIsPartOfKey(false)
                                .setDescription("")
                                .setNativeDataType("string")
    ...
    public void extendedFieldTest() throws IOException {
        ...
        List<SchemaField> expected = Stream.of(
                ...
                Pair.of(
                        new SchemaField()
                                .setFieldPath("[version=2.0].[type=extended_protobuf_Person].[type=string].test_coverage")
                                .setNullable(true)
                                .setIsPartOfKey(false)
                                .setDescription("")
                                .setNativeDataType("string")
